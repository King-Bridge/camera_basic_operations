...
cv2.createTrackbar("Hue Min","TrackBars",160,180,empty)
cv2.createTrackbar("Hue Max","TrackBars",10,180,empty)
cv2.createTrackbar("Sat Min","TrackBars",128,255,empty)
cv2.createTrackbar("Sat Max","TrackBars",255,255,empty)
cv2.createTrackbar("Val Min","TrackBars",128,255,empty)
cv2.createTrackbar("Val Max","TrackBars",255,255,empty)
cv2.createTrackbar("Kernel 1","TrackBars",3,20,empty)
cv2.createTrackbar("Kernel 2","TrackBars",2,20,empty)
cv2.createTrackbar("Kernel 3","TrackBars",5,50,empty)
...
while True:
    ...
    upper2 = np.array([255,s_max,v_max])
    # 获得指定颜色范围内的掩码
