...
if __name__=='__main__':
    ...
    # 视频保存路径
    video_path = f'/home/lation/Desktop/PUB.R/video/{int(time.time())}.mp4'
    video_depth_path = f'/home/lation/Desktop/PUB.R/depth_data/{int(time.time())}_depth.mp4'
    video_depthcolor_path = f'/home/lation/Desktop/PUB.R/depthcolor_data/{int(time.time())}_depthcolor.mp4'
    video_depthcolor_camera_path = f'/home/lation/Desktop/PUB.R//camera_colordepth/{int(time.time())}_depthcolor.mp4'
    # 初始化参数
    fps, w, h = 30, 640, 360
